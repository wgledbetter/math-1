...
TEST(ProbBetaBinomial, log_matches_lpmf) {
  ...
  EXPECT_FLOAT_EQ(
      (stan::math::beta_binomial_lpmf<true, int, int, double, double>(
          n, N, alpha, beta)),
      (stan::math::beta_binomial_log<true, int, int, double, double>(
          n, N, alpha, beta)));
  EXPECT_FLOAT_EQ(
      (stan::math::beta_binomial_lpmf<false, int, int, double, double>(
          n, N, alpha, beta)),
      (stan::math::beta_binomial_log<false, int, int, double, double>(
          n, N, alpha, beta)));
  EXPECT_FLOAT_EQ((stan::math::beta_binomial_lpmf<int, int, double, double>(
                      n, N, alpha, beta)),
                  (stan::math::beta_binomial_log<int, int, double, double>(
                      n, N, alpha, beta)));
}
